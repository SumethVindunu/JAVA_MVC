...
<body>
				...
				<div class="sidebar-menu">
					<ul class="menu px-3">
						...
						<li class="sidebar-item active "><a
							href="studentManagement.jsp" class='sidebar-link'> <i
								class="bi bi-grid-fill"></i> <span>Student Management</span>
						</a></li>
					...
					<div class="card-header d-flex justify-content-between">
						...
						<div>
							<button class="btn btn-primary" data-bs-toggle="modal"
								data-bs-target="#staticBackdrop">Add Student</button>
						</div>
					</div>
					<div class="card-body">
						<table class="table table-hover" id="table1">
							...
							<tbody>
								...
								<tr>
									...
									<td><a
										href="StudentServlet?action=delete&email=<%=student.getEmail()%>"><span
									...
									<a href="#" class="edit-link" data-bs-toggle="modal"
										...
										data-student-email="<%=student.getEmail()%>"
										data-student-tel="<%=student.getTel()%>"
										data-student-city="<%=student.getCity()%>"
										data-student-nic="<%=student.getNic()%>"
										data-student-grade="<%=student.getGrade()%>"> <span
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form class="row g-3 needs-validation" action="StudentServlet"
								method="POST">
    ...
    document.querySelectorAll('.edit-link').forEach(link => {
        link.addEventListener('click', function () {
            ...
            const sellerName = link.getAttribute('data-student-name');
            const sellerEmail = link.getAttribute('data-student-email');
            const sellerCity = link.getAttribute('data-student-city');
            const sellerNic = link.getAttribute('data-student-nic');
            const sellerGrade = link.getAttribute('data-student-grade');
            const sellerTel = link.getAttribute('data-student-tel');
